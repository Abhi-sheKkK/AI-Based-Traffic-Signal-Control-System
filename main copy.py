...
out = cv.VideoWriter('output_video.avi', fourcc, 20.0, (int(cap.get(3) // 2), int(cap.get(4) // 2)))  # Reduce resolution by half
...
while cap.isOpened():
    ...
    if frame_count % frame_interval == 0:
      ...
      right = (1079, 1491)
      left = (0, 1727)
    #   frame = cv.line(frame, (top[0], top[1]), (leftq[0], left[1]), (0, 255, 0), 10)
